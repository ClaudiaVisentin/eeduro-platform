#ifndef DELTASAFETYPROPERTIES_SERVER_HPP
#define DELTASAFETYPROPERTIES_SERVER_HPP
...
namespace eeduro {
	...
	//		waitingForApproval = 10,
		...
		class DeltaSafetyProperties_server : public eeros::safety::SafetyProperties {

			
		public:
			DeltaSafetyProperties_server(ControlSystem_server* cs);
		...
		private:
			ControlSystem_server* controlSys;
		};
	}
}
#endif // DELTASAFETYPROPERTIES_SERVER_HPP
