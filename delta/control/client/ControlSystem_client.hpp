#ifndef CONTROLSYSTEM_CLIENT_HPP_
#define CONTROLSYSTEM_CLIENT_HPP_
...
namespace eeduro {
	namespace delta {
		...
		public:
			ControlSystem_client(Client* clientThread);
...
//		protected:
			...
			eeduro::delta::ClientData 							clientData;
...
#endif // CONTROLSYSTEM_CLIENT_HPP_
