#include "MainSequence_server.hpp"
...
MainSequence_server::MainSequence_server(Sequencer* sequencer, ControlSystem_server* controlSys, SafetySystem* safetySys) :
