#include "MainSequenceFaulhaber_server.hpp"
...
MainSequenceFaulhaber_server::MainSequenceFaulhaber_server(Sequencer* sequencer, ControlSystem_server* controlSys, SafetySystem* safetySys) :
...
void MainSequenceFaulhaber_server::run() {
