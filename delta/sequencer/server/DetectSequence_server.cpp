...
DetectSequence_server::DetectSequence_server(Sequencer* sequencer, ControlSystem_server* controlSys) :
...
int DetectSequence_server::run(int position) {
...
void DetectSequence_server::waitUntilPointReached() {
