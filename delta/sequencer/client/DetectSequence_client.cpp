...
DetectSequence_client::DetectSequence_client(Sequencer* sequencer, ControlSystem_client* controlSys) :
...
int DetectSequence_client::run(int position) {
...
void DetectSequence_client::waitUntilPointReached() {
